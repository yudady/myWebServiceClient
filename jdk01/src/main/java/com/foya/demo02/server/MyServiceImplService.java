 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://server.demo02.foya.com/", wsdlLocation = "http://localhost:8888/demo02?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://server.demo02.foya.com/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/demo02?wsdl");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://server.demo02.foya.com/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.demo02.foya.com/", "MyServiceImplPort"), IMyService.class, features);
    }
